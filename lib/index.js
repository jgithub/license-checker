...
var flatten = function(options) {
    ...
    files.forEach(function(filename) {
        ...
        if (fs.lstatSync(licenseFile).isFile()) {
            ...
            // Some have a 'v' prefix on the version in the URL
            moduleInfo.versionedLicenseUrl = moduleInfo.repository + "/blob/" + json.version + "/" + path.basename(licenseFile);
            moduleInfo.altVersionedLicenseUrl = moduleInfo.repository + "/blob/v" + json.version + "/" + path.basename(licenseFile);
            moduleInfo.masterLicenseUrl = moduleInfo.repository + "/blob/" + "master" + "/" + path.basename(licenseFile);
        }
    });
